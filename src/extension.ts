...
export function activate(context: vscode.ExtensionContext) {
    ...
    // Register the document symbol provider for OpenFOAM files
    // This will integrate with the built-in Outline view
    const symbolProvider = new OpenFOAMSymbolProvider();
    
    // Register for specific file patterns that match OpenFOAM files
    ...
    context.subscriptions.push(
        vscode.languages.registerDocumentSymbolProvider(openfoamSelector, symbolProvider)
    );
